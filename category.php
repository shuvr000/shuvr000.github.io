            ...
            <div class="container_width">
                <div class="col-md-9 col-sm-9 col-xs-12">
                    <div class="left_section">
                        <h3>Design Based Post</h3>
                        
                        <?php

                            $select_sql="SELECT * from post_info WHERE category='$getid'";
                        ...
                        <div class="post">
                            ...
                            <div class="col-md-8 col-sm-8 col-xs-12">
                                ...
                                ?>
                                <a href="post_g.php?id=<?php echo $row['id'];?>/<?php echo $til;?>" target="_blank">Read More</a>
                            </div>
                        </div>
                            <?php
