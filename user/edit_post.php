<?php 
    ...
    // $result_cat_1 = $result_cat;

    $getid=$_GET['id'];
    $select_sql="SELECT * from post_info WHERE id='$getid'";
    $result_up = $conn->query($select_sql);
        ...
        if (empty($_POST['title']) || empty($_POST['category']) || empty($_POST['main_post'])) {
            ...
            if($error==0) {
                if($size<=1024*1024*5) {
                    ...
                    $ar=explode(".", $fileName);
                    $ext=end($ar);
                    $extension=array("jpg", "JPEG", "jpeg", "gif", "png", "PNG", "git");
                    if(in_array($ext, $extension)) {
                        ...
                        if(move_uploaded_file($temp, "../upload/".$fileName)) {
                            ...
                            $queryInsert="UPDATE post_info SET title='$title', category='$category', img_path='$imgpath',main_post='$main_post' WHERE id='$getid'";
                              ...
                              <fieldset>
                                  <div class="form-group">
                                    <div class="col-md-12">
                                      ...
                                      <input name="title" class="form-control" placeholder="Title Here..." type="text" value="<?php echo $row_up['title'] ?>">
                                    </div>
                                  </div>
                                  ...
                                  <select class="form-control" name="category" id="sel1" value="red">
                                  ...
                                  <div class="form-group">
                                    <div class="col-md-12">
                                        ...
                                        <textarea name="main_post" class="form-control" rows="5" id="comment"><?php echo $row_up['main_post'] ?></textarea>
                                    </div>
                                  </div>  
                                
                                  <div class="form-group">
                                    <div class="col-md-12">
                                      <input type="submit" name="update" class="btn btn-primary btn-lg btn-block info" value="Update">
                                    </div>
                                  </div>     
                              </fieldset> 
                            </form>
